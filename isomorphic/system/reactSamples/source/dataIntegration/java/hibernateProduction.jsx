...
SC.render(
    <VStack membersMargin="20" width="100%">
        <members>
            ...
            <ListGrid ID="boundList" dataSource="supplyItemSpringDMI" height="200" selectionChanged={onBoundListSelectionChanged}/>
            <SearchForm ID="boundForm" dataSource="supplyItemSpringDMI" numCols="6" autoFocus="false" useAllDataSourceFields="true">
                <fields>
            ...
            <DetailViewer ID="boundViewer" dataSource="supplyItemSpringDMI"/>
        </members>
    </VStack>,
