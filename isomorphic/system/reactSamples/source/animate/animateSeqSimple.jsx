...
import { SC, HLayout, HTMLFlow, IButton } from 'smartclient-eval/react';

// a "render target" can be defined to allow JSX to be loaded dynamically into an existing application.  This Showcase sets a
// render target of "showcaseSample" so each JSX file can be loaded and later removed when the user is done with the sample.
let target = SC.getRenderTarget() || "showcaseSample";

let onExpandBtnClick = function () {
    this.disable();
    ajaxDefinition.animateResize(310, 45, 'ajaxDefinition.animateResize(310,195); collapseBtn.enable();');
};
let onCollapseBtnClick = function () {
    this.disable();
    ajaxDefinition.animateResize(310, 45, 'ajaxDefinition.animateResize(75,45); expandBtn.enable();');
};
