...
let onAddEU_top_Click = function () {
...
let onAddAustralia_bottom_Click = function () {
    countryList.data.add({
        countryCode: 'AS',
...
SC.render(
    <>
        ...
        <IButton title="Add EU (top)" width="160" left="0" top="240" click={onAddEU_top_Click}/>

        <IButton title="Add Australia (bottom)" width="160" left="170" top="240" click={onAddAustralia_bottom_Click}/>
    </>,
