...
let onRemoveFirstClick = function() {return countryList.data.remove(countryList.data.get(0))};
let onRemoveFirstSelectedClick = function() {return countryList.data.remove(countryList.getSelectedRecord())};
let onRemoveAllSelectedClick = function() {return countryList.data.removeList(countryList.getSelection())};
...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} width="500" height="224">
            <fields>
        ...
        <IButton title="Remove first" width="140" left="0" top="240" click={onRemoveFirstClick}/>

        <IButton autoFit="true" title="Remove first selected" minWidth="140" left="160" top="240" click={onRemoveFirstSelectedClick}/>

        <IButton title="Remove all selected" width="140" left="320" top="240" click={onRemoveAllSelectedClick}/>
    </>,
    document.getElementById(target)
);

countryList.selectRecord(0);
