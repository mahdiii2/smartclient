...
SC.render(
    <ListGrid ID="countryList" data={countryData} headerHeight="40" wrapHeaderTitles="true" canSort="false" autoFitWidthApproach="both" width="380" height="224" headerAutoFitEvent="doubleClick" leaveHeaderMenuButtonSpace="false">
        <fields>
            <LGField name="countryCode" type="image" title="Flag Thumbnail" cellAlign="center" imageURLPrefix="flags/24/" imageURLSuffix=".png" autoFitWidth="true"/>
            <LGField name="countryName" title="Country of Origin" autoFitWidth="true"/>
