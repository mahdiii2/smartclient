...
SC.render(
    <ListGrid ID="countryList" data={countryData} leaveScrollbarGap="false" autoFitData="horizontal" autoFitMaxWidth="100%" width="100" height="224">
        <fields>
            <LGField name="countryCode" type="image" title="Flag" width="65" imageURLPrefix="flags/24/" imageURLSuffix=".png"/>
