...
import { SC, HStack, Img, LGField, ListGrid } from 'smartclient-eval/react';
...
SC.render(
    <HStack membersMargin="10" height="160">
        <members>
            <ListGrid ID="countryList1" data={countryData} canDragRecordsOut="true" canAcceptDroppedRecords="true" canReorderRecords="true" dragDataAction="copy" width="300" height="224">
                <fields>
            ...
            <ListGrid ID="countryList2" showAllRecords="true" emptyMessage="drop rows here" canAcceptDroppedRecords="true" canReorderRecords="true" width="200" height="224" left="350">
                <fields>
