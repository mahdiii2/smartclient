...
import { SC, HStack, Img, LGField, ListGrid, VStack } from 'smartclient-eval/react';
...
SC.render(
    <HStack membersMargin="10" height="160">
        <members>
            <ListGrid ID="countryList1" data={countryData} canDragRecordsOut="true" canAcceptDroppedRecords="true" canReorderRecords="true" dragDataAction="move" width="300" height="224">
                <fields>
            ...
            <ListGrid ID="countryList2" showAllRecords="true" emptyMessage="drop rows here" canDragRecordsOut="true" canAcceptDroppedRecords="true" canReorderRecords="true" dragDataAction="move" width="200" height="224">
                <fields>
