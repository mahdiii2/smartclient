...
let onRolloverOnClick = function() {return countryList.showRollOver = true;};
let onRolloverOffClick = function() {return countryList.showRollOver = false;};
...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} showRollOver="true" width="500" height="224">
            <fields>
        ...
        <IButton title="Rollover on" left="0" top="240" click={onRolloverOnClick}/>

        <IButton title="Rollover off" left="130" top="240" click={onRolloverOffClick}/>
    </>,
