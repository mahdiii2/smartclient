...
let on_Name_Click = function() {return countryList.setFieldProperties(1, {title:'Name'})};
let on_Country_Click = function() {return countryList.setFieldProperties(1, {title:'Country'})};
...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} canReorderFields="false" width="500" height="224" top="50">
            <fields>
        ...
        <IButton title="&quot;Name&quot;" left="0" click={on_Name_Click}/>

        <IButton title="&quot;Country&quot;" left="130" click={on_Country_Click}/>
    </>,
