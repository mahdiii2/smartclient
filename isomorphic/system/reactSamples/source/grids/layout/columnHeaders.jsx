...
let onShowHeaderClick = function() {return countryList.setShowHeader(true);};
let onHideHeaderClick = function() {return countryList.setShowHeader(false);};
...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} headerHeight="30" showHeader="false" width="500" height="232">
            <fields>
        ...
        <IButton title="Show header" left="0" top="250" click={onShowHeaderClick}/>

        <IButton title="Hide header" left="130" top="250" click={onHideHeaderClick}/>
    </>,
