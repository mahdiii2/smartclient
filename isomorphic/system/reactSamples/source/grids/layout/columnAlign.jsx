...
import { SC, DynamicForm, LGField, ListGrid, RadioGroupItem } from 'smartclient-eval/react';

// a "render target" can be defined to allow JSX to be loaded dynamically into an existing application.  This Showcase sets a
// render target of "showcaseSample" so each JSX file can be loaded and later removed when the user is done with the sample.
let target = SC.getRenderTarget() || "showcaseSample";

let onAlignmentChange = function(form,item,value,oldValue) {countryList.getField('countryCode').align = value; countryList.markForRedraw()};
...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} width="500" height="224" top="100">
            <fields>
        ...
        <DynamicForm>
            <items>
                <RadioGroupItem name="alignment" defaultValue="left" showTitle="false" change={onAlignmentChange}>
                    <valueMap>
                            <value>left</value>
                            <value>center</value>
                            <value>right</value>
