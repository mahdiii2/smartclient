...
let onCapitalShowIf = function(list,field,fieldNum) {return false};
let onShowCapitalsClick = function() {return countryList.showField('capital')};
let onHideCapitalsClick = function() {return countryList.hideField('capital')};
...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} canReorderFields="true" width="500" height="224">
            <fields>
                ...
                <LGField name="capital" title="Capital" showIf={onCapitalShowIf}/>
                <LGField name="continent" title="Continent"/>
            </fields>
        </ListGrid>

        <IButton title="Show Capitals" left="0" top="240" click={onShowCapitalsClick}/>

        <IButton title="Hide Capitals" left="130" top="240" click={onHideCapitalsClick}/>
    </>,
