...
let onSetDataClick = function() {return countryList.setData(countryData)};
let onClearDataClick = function() {return countryList.setData([])};
...
SC.render(
    <>
        <ListGrid ID="countryList" showEmptyMessage="true" emptyMessage="Click the &lt;b&gt;Set data&lt;/b&gt; button to populate this grid." width="500" height="224" top="50">
            <fields>
        ...
        <IButton title="Set data" left="0" click={onSetDataClick}/>

        <IButton title="Clear data" left="130" click={onClearDataClick}/>
    </>,
