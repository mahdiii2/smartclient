...
SC.render(
    <ListGrid ID="countryList" data={countryData} cellHeight="24" width="300" height="224">
        <fields>
            <LGField name="countryCode" type="image" title="Flag" width="60" imageURLPrefix="flags/24/" imageURLSuffix=".png" canEdit="false"/>
            <LGField name="countryName" title="Country"/>
            <LGField name="article" type="link" title="Info" width="50" align="center" linkText={isc.Canvas.imgHTML('[SAMPLE]other/openbook.png', 24, 24)}/>
        </fields>
    </ListGrid>,
