...
SC.render(
    <ListGrid ID="countryList" data={countryData} selectionType="single" width="500" height="224" showRollOverCanvas="true" showRollUnderCanvas="false" rollOverCanvasConstructor={isc.StretchImg}>
        <fields>
            <LGField name="countryCode" type="image" title="Flag" width="60" align="center" imageURLPrefix="flags/24/" imageURLSuffix=".png"/>
        ...
        <rollOverCanvasProperties>
        	...
        	<capSize>7</capSize>
        	<src>[SAMPLE]other/cellOverRecticle.png</src>
        </rollOverCanvasProperties>
    </ListGrid>,
