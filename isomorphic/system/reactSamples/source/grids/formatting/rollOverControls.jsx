...
SC.render(
    <ListGrid ID="countryList" data={countryData} selectionType="single" width="520" height="224" showRollOverCanvas="true" showRollUnderCanvas="false" rollOverCanvasConstructor={isc.HLayout}>
        <fields>
        ...
        <rollOverCanvasProperties>
        	...
        	<members>
        		<Button>
        			<_constructor>Button</_constructor>
        			<title>+</title>
        			<click>isc.say('Expanded record:' + this.echo(this.parentElement.record))</click>
        			<height>20</height>
        			<width>27</width>
        		</Button>
        		<Button>
        			<_constructor>Button</_constructor>
        			<title>-</title>
        			<click>isc.say('Collapsed record:' + this.echo(this.parentElement.record))</click>
        			<height>20</height>
        			<width>27</width>
        		</Button>
        	</members>
