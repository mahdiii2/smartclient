...
import { SC, DynamicForm, LGField, ListGrid, TextAreaItem } from 'smartclient-eval/react';

// a "render target" can be defined to allow JSX to be loaded dynamically into an existing application.  This Showcase sets a
// render target of "showcaseSample" so each JSX file can be loaded and later removed when the user is done with the sample.
let target = SC.getRenderTarget() || "showcaseSample";

let onCountryListCellSelectionChanged = function (cellList) {
...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} canDragSelect="true" selectionType="multiple" width="500" height="224" canSelectCells="true" cellSelectionChanged={onCountryListCellSelectionChanged}>
            <fields>
        ...
        <DynamicForm ID="displayForm" width="250" height="100" top="250">
            <fields>
                <TextAreaItem name="countries" title="Selected Cells" titleOrientation="top" width="*" colSpan="*"/>
            </fields>
        </DynamicForm>
    </>,
