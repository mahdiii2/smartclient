...
let onExpandBlueClick = function() {return sectionStack.expandSection(0)};
let onCollapseBlueClick = function() {return sectionStack.collapseSection(0)};
    ...
    <>
        <SectionStack visibilityMode="multiple" ID="sectionStack" width="300" height="350" border="1px solid blue">
            <sections>
                ...
                <SectionStackSection title="Yellow Piece" expanded="false">
                    <items>
        ...
        <VLayout membersMargin="8" left="325">
            <members>
                <IButton title="Expand Blue" width="150" click={onExpandBlueClick}/>
                <IButton title="Collapse Blue" width="150" click={onCollapseBlueClick}/>
            </members>
        </VLayout>
    </>,
