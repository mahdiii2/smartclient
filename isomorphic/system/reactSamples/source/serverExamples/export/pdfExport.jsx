...
import { SC, HLayout, IButton, LGField, ListGrid, VLayout } from 'smartclient-eval/react';

// a "render target" can be defined to allow JSX to be loaded dynamically into an existing application.  This Showcase sets a
// render target of "showcaseSample" so each JSX file can be loaded and later removed when the user is done with the sample.
let target = SC.getRenderTarget() || "showcaseSample";

let onButtonPdfClick = function () {
    ...
    countryList.setProperties({ alternateFieldStyles: false });
    var settings = {
        skinName: 'Enterprise',
...
let onButtonPreviewClick = function () {
...
SC.render(
    <VLayout membersMargin="5" ID="mainLayout" width="500" height="350">
        <members>
            <ListGrid ID="countryList" data={countryData} canExpandRecords="true" expansionMode="detailField" detailField="background" width="500" height="350">
                <fields>
            ...
            <HLayout membersMargin="5" ID="hLayout">
                <members>
                    <IButton title="Export" ID="buttonPdf" width="150" click={onButtonPdfClick}/>
                    <IButton title="Show Print Preview" ID="buttonPreview" width="150" click={onButtonPreviewClick}/>
                </members>
            </HLayout>
        </members>
    </VLayout>,
