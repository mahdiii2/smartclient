...
import { SC, DynamicForm, FacetChart, HLayout, PickTreeItem, SavedSearchItem, SelectItem, SpacerItem, Tree, VLayout } from 'smartclient-eval/react';
...
let onSsiSavedSeachItemSearchChanged = function (newCriteria, searchData) {
    dynamicChart.setProperty('title', 'Revenue for ' + searchData.searchName);
    return true;
};
        ...
        <members>
            <HLayout height="40">
                <members>
                    ...
                    <DynamicForm ID="timeSelector" numCols="5" wrapItemTitles="false" width="400">
                        <items>
                            ...
                            <SpacerItem/>
                            <SavedSearchItem canAddSearch="true" targetComponent="dynamicChart" showTitle="true" name="ssiSavedSeachItem" ID="ssiGridViewItem" title="Grid View" width="220" searchChanged={onSsiSavedSeachItemSearchChanged}/>
                        </items>
                    </DynamicForm>
                </members>
            </HLayout>
