...
SC.render(
    <HStack width="100%">
        <members>
            <FacetChart chartType="Column" stacked="true" showTitle="false" valueTitle="Percent" showChartRect="true" width="500" height="400" border="1px solid black" autoDraw="false">
                <data>
