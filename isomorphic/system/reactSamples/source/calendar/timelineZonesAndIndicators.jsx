...
import { SC, CalendarEvent, Timeline } from 'smartclient-eval/react';
...
SC.render(
    <Timeline eventSnapGap="360" disableWeekends="false" data={events} ID="timeline" height="480" startDate={_calStart} endDate={_calEnd} lanes={developers} canEditLane="true" showEventDescriptions="false" columnsPerPage="5" laneEventPadding="2" showZones="true" showIndicators="true">
        <zones>
            <CalendarEvent name="Week 27 - July 3-6" startDate={new Date(2020, 6, 3, 3)} endDate={new Date(2020, 6, 6, 9)}/>
            <CalendarEvent name="Week 28 - July 10-14" startDate={new Date(2020, 6, 10, 20)} endDate={new Date(2020, 6, 14, 14)}/>
        </zones>
        <indicators>
            <CalendarEvent name="July 4 - noon" description="Independence day" startDate={new Date(2020, 6, 4, 12)}/>
        </indicators>
        <headerLevels>
        	<unit>week</unit>
        </headerLevels>
