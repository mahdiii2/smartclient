...
import { SC, Calendar, DSField, DataSource, HeaderItem, RadioGroupItem, SelectItem, TextItem } from 'smartclient-eval/react';
...
SC.render(
    <>
        <DataSource ID="eventDS" title="eventDS" clientOnly="true" testData={eventData}>
            <fields>
                <DSField name="eventId" type="sequence" primaryKey="true"/>
                <DSField name="name"/>
                <DSField name="description"/>
                <DSField name="startDate"/>
                <DSField name="endDate"/>
            </fields>
        </DataSource>

        <Calendar dataSource="eventDS" ID="eventCalendar" autoFetchData="true" startDate={eventData.getDataStartDate()}>
            <eventEditorFields>
                <TextItem defaultValue="A New Event" name="name" required="true"/>
                <TextItem name="description"/>
                <HeaderItem defaultValue="Event Options"/>
                <SelectItem defaultToFirstOption="true" name="repeats" title="Repeats" colSpan="4">
                    <valueMap>
                ...
                <SelectItem defaultToFirstOption="true" name="reminderType" title="Reminder" width="70">
                    <valueMap>
                            <value>Pop-up</value>
                            <value>Email</value>
                    </valueMap>
                </SelectItem>
                <TextItem defaultValue="10" name="reminderValue" showTitle="false" width="60"/>
                <SelectItem defaultToFirstOption="true" name="reminderUnits" showTitle="false" width="70">
                    <valueMap>
                            <value>minutes</value>
                            <value>hours</value>
                            <value>days</value>
            ...
            <eventDialogFields>
                <TextItem name="name" required="true"/>
                <RadioGroupItem vertical="false" name="sharing" title="Sharing" width="50">
                    <valueMap>
                            <value>Public</value>
                            <value>Private</value>
                    </valueMap>
