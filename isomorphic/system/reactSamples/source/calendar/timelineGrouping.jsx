...
SC.render(
    <Timeline disableWeekends="false" data={events} ID="timeline" height="451" startDate={_calStart} endDate={_calEnd} lanes={developers} canEditLane="true" showEventDescriptions="false" columnsPerPage="5" laneEventPadding="2" canGroupLanes="true" laneGroupByField="devGroup">
        <headerLevels>
        	<unit>week</unit>
        </headerLevels>
        <headerLevels>
