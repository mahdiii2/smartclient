...
SC.render(
    <>
        ...
        <Calendar dataSource="eventDS" showWorkday="true" scrollToWorkday="true" showWeekends="false" ID="eventCalendar" autoFetchData="true" startDate={eventData.getDataStartDate()} styleWorkday="true" sizeToWorkday="true"/>
    </>,
