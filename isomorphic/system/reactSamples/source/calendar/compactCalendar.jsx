...
import { SC, Calendar, DSField, DataSource } from 'smartclient-eval/react';
...
SC.render(
    <>
        ...
        <Calendar dataSource="eventDS" canCreateEvents="false" showDateChooser="false" disableWeekends="false" showDayHeaders="false" showOtherDays="false" showDayView="false" showWeekView="false" ID="eventCalendar" width="500" height="220" autoFetchData="true" showDatePickerButton="false" showAddEventButton="false" startDate={eventData.getDataStartDate()} getDayBodyHTML={onEventCalendarGetDayBodyHTML} dayBodyClick={onEventCalendarDayBodyClick}/>
    </>,
