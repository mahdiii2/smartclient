...
//>RealtimeMessaging
    {id:"exMessaging",    title:"Simple Chat (Messaging option)",          parentId:"examples",
	                      isFolder:false,
	                      needServer:true,
                          requiresModules: ["SCServer"],
	                      iconSrc:"example/example_chat.png",
	                      link:"examples/messaging/simple_chat.jsp",
	                      description:"Simple server-brokered chat example demonstrating server-push capability of the optional Real-Time Messaging module."
	},
//<RealtimeMessaging
...
*/
	...
	{id:"visualBuilder",  title:"Reify.com",                          parentId:"tools",
	                      isFolder:false,
	                      needServer:true,
                          requiresModules: ["SCServer"],
	                      iconSrc:"other/builder.png",
	                      link:"http://reify.com",
	                      description:"Cloud-based Reify tool for building SmartClient applications."
	},
	...
	{id:"dsGenerator",   title:"DataSource Generator",                           parentId:"tools",
                          ...
                          requiresModules: (function () {
                              return ["SCServer", "BatchDSGenerator"]//>Enterprise
                                    ,["SCServer"]                    //<Enterprise
                          })(),
