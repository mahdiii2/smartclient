...
let onCountryListCellDoubleClick = function(record,rowNum,colNum) {return this.sayCellEvent('Double-clicked', record, colNum)};
let onCountryListCellContextClick = function(record,rowNum,colNum) {this.sayCellEvent('Context-clicked', record, colNum); return false;};
let onCountryListSayCellEvent = function (eventText, record, colNum) {
    isc.say(eventText + ' <b>' + this.getField(colNum).title + ':' + record[this.getFieldName(colNum)] + '</b> (Country:' + record.countryName + ')');
};
let onCountryListCellClick = function (record, rowNum, colNum) {
    clickDisplay.setContents('Clicked <b>' + this.getField(colNum).title + ':' + record[this.getFieldName(colNum)] + '</b> (Country:' + record.countryName + ')');
};
...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} width="500" height="224" cellDoubleClick={onCountryListCellDoubleClick} cellContextClick={onCountryListCellContextClick} sayCellEvent={onCountryListSayCellEvent} cellClick={onCountryListCellClick}>
            <fields>
        ...
        <Label contents="click a value in the grid" align="center" title="clickDisplay" ID="clickDisplay" width="200" top="250" border="1px solid #808080"/>
    </>,
