...
SC.render(
    <ListGrid ID="countryList" data={countryData} width="500" height="224">
        <fields>
            <LGField name="countryCode" type="image" title="Flag" width="60" imageURLPrefix="flags/24/" imageURLSuffix=".png" prompt="Small image of national flag"/>
            <LGField name="countryName" title="Country" prompt="Conventional short form of country name"/>
            <LGField name="capital" title="Capital" prompt="Location of seat of government"/>
            <LGField name="independence" type="date" title="Nationhood" width="100" prompt="Date of sovereignty, founding, or other significant nationhood event"/>
        </fields>
    </ListGrid>,
