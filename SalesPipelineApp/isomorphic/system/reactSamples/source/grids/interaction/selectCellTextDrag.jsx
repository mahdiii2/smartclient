...
import { SC, DynamicForm, LGField, ListGrid, TextAreaItem, VLayout } from 'smartclient-eval/react';
...
SC.render(
    <VLayout membersMargin="10" width="100%" height="100%">
        <members>
            <ListGrid data={countryData} fixedRecordHeights="false" wrapCells="true" showRollOver="false" selectionType="none" width="100%" height="100%" alternateRowStyles="true" canDragSelectText="true">
                <fields>
                    <LGField name="countryName" title="Country" width="120"/>
                    <LGField name="background" title="Background"/>
                    <LGField name="countryCode" type="image" title="Flag" width="60" align="center" imageSize="24" imageURLPrefix="flags/24/" imageURLSuffix=".png"/>
                </fields>
            </ListGrid>
            <DynamicForm width="100%" height="150">
                <fields>
                    <TextAreaItem name="textArea" title="Pasted value" width="100%" height="100%"/>
                </fields>
            </DynamicForm>
        </members>
    </VLayout>,
