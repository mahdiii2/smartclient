...
SC.render(
    <ListGrid ID="countryList" dataSource="countryDS" canEdit="true" editEvent="click" autoFetchData="true" width="550" height="224">
        <fields>
            <LGField name="countryCode" type="image" title="Flag" width="40" imageURLPrefix="flags/24/" imageURLSuffix=".png" canEdit="false"/>
            <LGField name="countryName" canEdit="false"/>
            <LGField name="continent"/>
            <LGField name="member_g8" canEdit="false"/>
