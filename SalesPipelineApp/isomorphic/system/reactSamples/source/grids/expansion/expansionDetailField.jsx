...
SC.render(
    <ListGrid ID="countryList" data={countryData} canExpandRecords="true" expansionMode="detailField" detailField="background" width="500" height="300" expansionFieldImageShowSelected="true">
        <fields>
