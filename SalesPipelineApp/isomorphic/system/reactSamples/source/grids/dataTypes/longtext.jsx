...
SC.render(
    <ListGrid ID="countryList" data={countryData} modalEditing="true" canEdit="true" editEvent="click" width="500" height="224">
        <fields>
            <LGField name="countryCode" type="image" title="Flag" width="50" imageURLPrefix="flags/24/" imageURLSuffix=".png" canEdit="false"/>
            <LGField name="countryName" title="Country"/>
            <LGField name="government" title="Government" length="500"/>
        </fields>
    </ListGrid>,
