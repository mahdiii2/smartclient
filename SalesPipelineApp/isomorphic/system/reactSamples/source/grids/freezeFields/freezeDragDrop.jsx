...
SC.render(
    <>
        <ListGrid ID="countryList1" data={countryData1} canDragRecordsOut="true" canAcceptDroppedRecords="true" canReorderRecords="true" dragDataAction="move" width="325" height="224">
            <fields>
                <LGField name="countryCode" type="image" title="Flag" width="40" imageURLPrefix="flags/24/" imageURLSuffix=".png" frozen="true"/>
                <LGField name="countryName" title="Country" width="100" frozen="true"/>
                <LGField name="capital" title="Capital" width="100"/>
                <LGField name="continent" title="Continent" width="100"/>
                <LGField name="government" title="Government" width="100"/>
                <LGField name="independence" type="date" title="Independence" width="100"/>
                <LGField name="population" type="int" title="Population" width="100"/>
            </fields>
        </ListGrid>

        <ListGrid ID="countryList2" data={countryData2} canDragRecordsOut="true" canAcceptDroppedRecords="true" canReorderRecords="true" dragDataAction="move" width="225" height="224" left="350">
            <fields>
