...
let onListGridCreateRecordComponent = function (record, colNum) {
    ...
    if (fieldName == 'iconField') {
        ...
        var editImg = isc.ImgButton.create({
            ...
            showRollOver: false,
            layoutAlign: 'center',
            src: '[SAMPLE]icons/16/comment_edit.png',
        ...
        var chartImg = isc.ImgButton.create({
            ...
            showRollOver: false,
            layoutAlign: 'center',
            src: '[SAMPLE]icons/16/chart_bar.png',
            prompt: 'View Chart',
            height: 16,
            width: 16,
            grid: this,
        ...
        var button = isc.IButton.create({
            ...
            width: 65,
            layoutAlign: 'center',
            icon: 'flags/24/' + record['countryCode'] + '.png',
            title: 'Info',
            click: function () {
...
let onListGridUpdateRecordComponent = function (record, colNum, component, recordChanged) {
    var fieldName = this.getFieldName(colNum);
    if (fieldName == 'iconField') {
...
SC.render(
    <ListGrid data={countryData} canResizeFields="true" canRemoveRecords="true" showRecordComponents="true" width="600" height="224" virtualScrolling="false" showRecordComponentsByCell="true" recordComponentPoolingMode="recycle" createRecordComponent={onListGridCreateRecordComponent} updateRecordComponent={onListGridUpdateRecordComponent}>
        <fields>
            ...
            <LGField name="buttonField" title="Info" align="center"/>
            <LGField name="iconField" title="Comments/Stats" width="110"/>
        </fields>
    </ListGrid>,
