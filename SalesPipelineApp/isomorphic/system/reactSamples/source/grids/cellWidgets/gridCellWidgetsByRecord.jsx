...
SC.render(
    <ListGrid data={countryData} canResizeFields="true" canRemoveRecords="true" showRecordComponents="true" width="750" height="250" recordComponentPoolingMode="recycle" createRecordComponent={onListGridCreateRecordComponent} updateRecordComponent={onListGridUpdateRecordComponent}>
        <fields>
