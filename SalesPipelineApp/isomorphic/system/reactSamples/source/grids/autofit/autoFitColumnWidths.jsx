...
SC.render(
    <ListGrid ID="countryList" data={countryData} canSort="false" autoFitWidthApproach="both" width="100%" height="224" headerAutoFitEvent="doubleClick" leaveHeaderMenuButtonSpace="false">
        <fields>
            ...
            <LGField name="countryName" title="Country" autoFitWidth="true"/>
