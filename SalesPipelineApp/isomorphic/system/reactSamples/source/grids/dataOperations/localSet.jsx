...
let onShowAllClick = function() {return countryList.setData(countryData)};
let onShowFirst5Click = function() {return countryList.setData(countryData.getRange(0,5))};
let onShowEuropeClick = function() {return countryList.setData(countryData.findAll('continent','Europe'))};
...
SC.render(
    <>
        ...
        <IButton title="Show all" left="0" top="240" click={onShowAllClick}/>

        <IButton title="Show first 5" left="130" top="240" click={onShowFirst5Click}/>

        <IButton title="Show Europe" left="260" top="240" click={onShowEuropeClick}/>
    </>,
