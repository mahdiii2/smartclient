...
import { SC, Label, ListGrid } from 'smartclient-eval/react';
...
SC.render(
    <>
        <ListGrid ID="supplyList" dataSource="filterOnServer" showFilterEditor="true" filterOnKeypress="true" autoFetchData="true" width="700" height="300"/>
