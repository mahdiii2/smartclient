...
SC.render(
    <ListGrid ID="countryList" data={countryData} baseStyle="simpleCell" alternateRecordStyles="false" selectionType="single" width="500" height="224" alternateFieldStyles="false" showSelectionUnderCanvas="true" animateSelectionUnder="true" showRollUnderCanvas="true" animateRollUnder="true">
        <fields>
        ...
        <selectionUnderCanvasProperties>
        	<animateShowEffect>fade</animateShowEffect>
        	<animateFadeTime>1000</animateFadeTime>
        	<backgroundColor>#ffff40</backgroundColor>
        </selectionUnderCanvasProperties>
