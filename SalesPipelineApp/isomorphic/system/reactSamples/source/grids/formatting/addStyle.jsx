...
let onCountryListGetCellCSSText = function (record, rowNum, colNum) {
...
SC.render(
    <ListGrid ID="countryList" data={countryData} canDragSelect="true" sortField="1" width="500" height="224" getCellCSSText={onCountryListGetCellCSSText}>
        <fields>
