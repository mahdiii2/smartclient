...
SC.render(
    <ListGrid ID="countryList" data={countryData} emptyCellValue="unknown" editByCell="true" modalEditing="true" canEdit="true" width="500" height="224">
        <fields>
            ...
            <LGField name="independence" type="date" title="Nationhood" emptyCellValue="--"/>
        </fields>
    </ListGrid>,
