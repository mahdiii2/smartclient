...
SC.render(
    <ListGrid ID="countryList" data={countryData} baseStyle="simpleCell" alternateRecordStyles="false" showRollOver="false" selectionType="single" width="500" height="224" showSelectionUnderCanvas="true" selectionUnderCanvasConstructor={isc.StretchImg}>
        <fields>
            <LGField name="countryCode" type="image" title="Flag" width="55" align="center" imageURLPrefix="flags/24/" imageURLSuffix=".png"/>
        ...
        <selectionUnderCanvasProperties>
        	...
        	<capSize>7</capSize>
        	<src>[SAMPLE]other/cellSelected.png</src>
        </selectionUnderCanvasProperties>
    </ListGrid>,
