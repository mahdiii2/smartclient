...
const CountryListGrid = SC.defineClass('CountryListGrid', ListGrid);
isc.CountryListGrid.addProperties({
    width: 500,
    height: 184,
...
SC.render(
    <>
        <CountryListGrid ID="countryList1" baseStyle="myBoxedGridCell"/>

        <CountryListGrid ID="countryList2" baseStyle="myOtherGridCell" top="220"/>
    </>,
