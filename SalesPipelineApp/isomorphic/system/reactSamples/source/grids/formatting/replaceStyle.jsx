...
let onCountryListGetBaseStyle = function (record, rowNum, colNum) {
...
SC.render(
    <ListGrid ID="countryList" data={countryData} canDragSelect="true" baseStyle="cell" sortField="1" width="500" height="224" alternateFieldStyles="false" getBaseStyle={onCountryListGetBaseStyle}>
        <fields>
            ...
            <LGField name="population" type="number" title="Population"/>
        </fields>
    </ListGrid>,
