...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} selectionType="single" width="500" height="224" selectionUpdated={onCountryListSelectionUpdated}>
            <fields>
        ...
        <ListGrid ID="selectedCountries" showAllRecords="true" emptyMessage="&lt;b&gt;nothing selected&lt;/b&gt;" width="250" height="100" top="250">
            <fields>
                <LGField name="countryName" title="Selected country"/>
            </fields>
        </ListGrid>
    </>,
