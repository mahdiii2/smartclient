...
let onCountryListSelectionUpdated = function(record,recordList) {return selectedCountries.setData(this.getSelection())};
...
SC.render(
    <>
        <ListGrid ID="countryList" data={countryData} selectionAppearance="checkbox" width="500" height="224" selectionUpdated={onCountryListSelectionUpdated}>
            <fields>
