...
let onGdpFormatCellValue = function(value,record,rowNum,colNum,grid) {return isc.NumberUtil.format(value*1000, ',0')};
    ...
    <>
        <DataSource ID="countryDS" title="countryDS" clientOnly="true" testData={countryData}>
            <fields>
                ...
                <DSField name="gdp" type="float" title="GDP ($B)"/>
            </fields>
        </DataSource>

        <ListGrid ID="countryList" dataSource="countryDS" autoFetchData="true" width="500" height="224">
            <fields>
                ...
                <LGField name="independence" title="Nationhood" width="100" align="center"/>
                <LGField name="population" format="0.0"/>
                <LGField name="gdp" title="GDP ($M)" formatCellValue={onGdpFormatCellValue}/>
            </fields>
        </ListGrid>
    </>,
