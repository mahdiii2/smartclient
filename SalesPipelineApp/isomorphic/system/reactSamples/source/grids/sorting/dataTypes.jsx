...
let onGdp_percapFormatCellValue = function (value, record) {
    var gdpPerCapita = Math.round(record.gdp * 1000000000 / record.population);
    return isc.NumberUtil.format(gdpPerCapita, '\xA4,0.00');
};
let onGdp_percapSortNormalizer = function (record) {
...
SC.render(
    <ListGrid ID="countryList" data={countryData} sortField="3" sortDirection="descending" width="550" height="224">
        <fields>
            <LGField name="countryCode" type="image" title="Flag" width="60" imageURLPrefix="flags/24/" imageURLSuffix=".png"/>
            <LGField name="countryName" title="Country" width="90"/>
            <LGField name="independence" type="date" title="Nationhood" width="100"/>
            <LGField name="area" type="float" title="Area (km&amp;sup2;)" format=",0"/>
            <LGField name="gdp_percap" title="GDP (per capita)" align="right" formatCellValue={onGdp_percapFormatCellValue} sortNormalizer={onGdp_percapSortNormalizer}/>
        </fields>
    </ListGrid>,
