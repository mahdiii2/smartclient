...
SC.render(
    <ListGrid ID="countryList" data={countryData} sortField="2" sortDirection="descending" width="500" height="224">
        <fields>
            <LGField name="countryCode" type="image" title="Flag" width="60" imageURLPrefix="flags/24/" imageURLSuffix=".png" canSort="false"/>
            <LGField name="countryName" title="Country"/>
            <LGField name="population" title="Population" format=",0"/>
            <LGField name="area" title="Area (km&amp;sup2;)" format=",0"/>
        </fields>
    </ListGrid>,
