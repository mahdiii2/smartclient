...
SC.render(
    <HStack membersMargin="10" width="100%">
        <members>
            <DynamicForm ID="uploadForm" dataSource="mediaLibraryHB" width="300" autoDraw="false">
                <fields>
                    <TextItem name="title"/>
            ...
            <VLayout ID="mainLayout" width="500" height="250" autoDraw="false">
                <members>
                    ...
                    <TileGrid ID="mediaTileGrid" dataSource="mediaLibraryHB" tileWidth="100" tileHeight="150" width="100%" height="224" autoFetchData="true" autoDraw="false"/>
                    <ListGrid ID="mediaListGrid" dataSource="mediaLibraryHB" width="100%" height="224" autoDraw="false"/>
                </members>
            </VLayout>
        </members>
    </HStack>,
