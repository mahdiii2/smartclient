...
SC.render(
    <>
        ...
        <ListGrid ID="cartItemList" dataSource="scripting_cartItem" showFilterEditor="true" canEdit="true" canAcceptDroppedRecords="true" autoFetchData="true" canRemoveRecords="true" width="400" height="224" left="320">
            <fields>
