...
import { SC, Tree, TreeGrid } from 'smartclient-eval/react';
...
SC.render(
    <TreeGrid ID="employeeTree" nodeIcon="[SAMPLE]icons/16/person.png" folderIcon="[SAMPLE]icons/16/person.png" closedIconSuffix="" showOpenIcons="false" showDropIcons="false" selectionAppearance="checkbox" width="500" height="400" showSelectedStyle="false" showPartialSelection="true" cascadeSelection="true">
