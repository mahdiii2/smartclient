...
SC.render(
    <>
        <RestDataSource fetchDataURL="[ISOMORPHIC]/system/reference/inlineExamples/dataIntegration/json/responses/country_fetch_rest.js" addDataURL="[ISOMORPHIC]/system/reference/inlineExamples/dataIntegration/json/responses/country_add_rest.js" removeDataURL="[ISOMORPHIC]/system/reference/inlineExamples/dataIntegration/json/responses/country_remove_rest.js" updateDataURL="[ISOMORPHIC]/system/reference/inlineExamples/dataIntegration/json/responses/country_update_rest.js" ID="countryDS" dataFormat="json" title="countryDS">
            <fields>
