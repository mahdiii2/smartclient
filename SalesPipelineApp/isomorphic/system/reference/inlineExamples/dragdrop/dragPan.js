isc.Canvas.create({
    ...
    dragStop : function () {
        ...
        var innerContentWidth = this.getInnerContentWidth(),
            ...
            clampedScrollLeft = Math.max(innerContentWidth, Math.min(scrollLeft,
                 this.getScrollWidth() - 2 * innerContentWidth + img.padding));
            scrollTop = this.getScrollTop(),
            clampedScrollTop = Math.max(innerContentWidth, Math.min(scrollTop,
                 this.getScrollHeight() - 2 * innerContentWidth));
