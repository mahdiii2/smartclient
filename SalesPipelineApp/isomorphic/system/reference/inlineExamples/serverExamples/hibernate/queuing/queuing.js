isc.DynamicForm.create({
    ...
    findOrders: function () {
        ...
        if (!sectionStack.isDrawn()) sectionStack.draw();
...
serverCount.observe(isc.RPCManager, "queueSent", function (requests) {
    if (serverCount && !serverCount.destroyed) isc.RPCManager.updateServerContactLabel(requests);
});
