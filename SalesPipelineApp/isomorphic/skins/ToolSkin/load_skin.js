...
if (isc.ComponentEditor) {
    ...
    isc.TComponentEditor.changeDefaults("TOverflowItemDefaults", {
        width:"*"
    });
    isc.TComponentEditor.changeDefaults("TEnumDynamicPropertyItemDefaults", {
        width:"*"
    });
    isc.TComponentEditor.changeDefaults("TDynamicPropertyEditorItemDefaults", {
        width:"*"
    });
...
isc.TTextItem.addProperties({
    ...
    height:isc.Browser.isSafari ? 22 : 22
})
...
isc.TDynamicPropertyEditorItem.addProperties({
    titleStyle:"tFormTitle",
    hintStyle:"tTextItem",
    textBoxStyle:"tTextItem",
    height:isc.Browser.isSafari ? 22 : 22
